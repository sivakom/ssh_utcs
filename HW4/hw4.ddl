...
DROP TABLE SIM_proj_own CASCADE CONSTRAINTS ;
...
CREATE TABLE SIM_proj_own
  (
    SIM_project_project_id INTEGER ,
    SIM_Person_person_id   INTEGER ,
    ownership_id           INTEGER NOT NULL
  ) ;
ALTER TABLE SIM_proj_own ADD CONSTRAINT SIM_proj_own_PK PRIMARY KEY ( ownership_id ) ;
...
ALTER TABLE SIM_proj_own ADD CONSTRAINT SIM_proj_own_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE SIM_proj_own ADD CONSTRAINT SIM_proj_own_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
