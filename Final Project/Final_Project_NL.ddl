...
CREATE UNIQUE INDEX NL_Employees__IDX ON NL_Employees
  (
...
ALTER TABLE NL_e2m ADD CONSTRAINT NL_e2m_PK PRIMARY KEY ( user_mem ) ;
...
ALTER TABLE NL_Employees ADD CONSTRAINT NL_Employees_NL_Member_FK FOREIGN KEY ( NL_Member_member_id ) REFERENCES NL_Member ( member_id ) ;

ALTER TABLE NL_Member ADD CONSTRAINT NL_Member_NL_Employees_FK FOREIGN KEY ( NL_Employees_user_id ) REFERENCES NL_Employees ( user_id ) ;

ALTER TABLE NL_e2m ADD CONSTRAINT NL_e2m_NL_Employees_FK FOREIGN KEY ( NL_Employees_user_id ) REFERENCES NL_Employees ( user_id ) ;
